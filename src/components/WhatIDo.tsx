        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>FRONT-END DEV</h3>
              <h4>Modern & Responsive Web Experiences</h4>
              <p>
                Front-end developer focused on building responsive,
                user-friendly websites with clean UI and smooth performance.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Design That Engages Users</h4>
              <p>
                I focus on creating intuitive and engaging user experiences by
                improving layout, navigation, and interaction flow.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">UX Thinking</div>
                <div className="what-tags">User Flow</div>
                <div className="what-tags">Interaction Design</div>
                <div className="what-tags">UI Consistency</div>
                <div className="what-tags">Usability</div>
              </div>
              <div className="what-arrow"></div>
            </div>
          </div>
